...
test_*.py modules from tests_suite/connect_3cx/tests/ and exposes
them as submodules so Odoo's test discovery (inspect.getmembers +
ismodule) picks them up.
