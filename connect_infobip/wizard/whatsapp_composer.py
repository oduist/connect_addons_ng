...
class InfobipWhatsappComposer(models.TransientModel):
    _name = 'connect.infobip.whatsapp_composer'
    _description = 'Send WhatsApp Message (Infobip)'
    ...
    template_id = fields.Many2one('connect.infobip.whatsapp_template', string='Template',
    ...
    def default_get(self, fields_list):
        ...
        sender = self.env['connect.infobip.whatsapp_sender'].get_default_sender(self.env.user)
        if sender:
