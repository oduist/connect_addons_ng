...
class Exten(models.Model):
    _name = 'connect.freeswitch.exten'
    _description = 'FreeSWITCH Extension'
    _order = 'number'
    ...
    dst = fields.Reference(
        ...
        selection=[
            ('connect.user', 'User'),
            ('connect.freeswitch.callflow', 'Call Flow'),
            ('connect.freeswitch.endpoint', 'Endpoint'),
